...
export class ContactFormComponent implements OnInit {
    ...
    this.http
      ...
      .subscribe(
        (authenticatedResponse: {
          result: { token: string; roles: string[] };
        }) => {
  ...
  checkout() {
    this.http
      .get(
        "https://api2.createdigitalsolutions.com/websites/60dafcc14b162471912edc48"
      )
      .subscribe(
        (websiteData: {
          result: {
          ...
          this.http
            ...
            .subscribe((basketToPurchase: { result: string }) => {
              Stripe(websiteData.result.stripePublic)
                .redirectToCheckout({
